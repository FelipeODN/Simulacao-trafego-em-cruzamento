...
titulo = pygame.display.set_caption("Simulação 8")
c_rua,l_rua =  c , l/2.8
...
# Legenda comandos:
    ...
    texto_limpar2 = fonte.render(limpar_via2,True,('white'))
    limpar_via3 = "aperte '3' para limpar via 3"
    texto_limpar3 = fonte.render(limpar_via3,True,'white')
    limpar_via4 = "aperte '4' para limpar via 4"
    texto_limpar4 = fonte.render(limpar_via4,True,'white')
    limpar_tudo = "aperte 'c' para limpar tudo"
    texto_limpar_tudo = fonte.render(limpar_tudo,True,'white')
